...
A ideia é se poder cadastrar as informações dos colaboradores em múltiplas árvores que possam ser consultadas com múltiplus objetivos.
...
//############################## Dados Para Teste ##########################//
// colocar no campo inserir 
/*
        colaborador *aux0 = new colaborador;
        aux0->nome = "africa";
        aux0->dtsaida = "03/10/2190";
        aux0->dtentrada = "09/10/1992";

        colaborador *aux1 = new colaborador;
        aux1->nome = "zeus";
        aux1->dtsaida = "03/10/2006";
        aux1->dtentrada = "09/10/1987";

        colaborador *aux2 = new colaborador;
        aux2->nome = "perseu";
        aux2->dtsaida = "03/10/2700";
        aux2->dtentrada = "09/10/1956";
*/
//############################## Dados Para Teste ##########################//
